...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('{"clientkey":"abc123"}', '{"clientkey":"[REDACTED]"}'),
        ('{"ClientKey":"abc123"}', '{"ClientKey":"[REDACTED]"}'),
        ('{"CLIENTKEY":"abc123"}', '{"CLIENTKEY":"[REDACTED]"}'),
        ('{"signingKey":"abc123"}', '{"signingKey":"[REDACTED]"}'),
        ('{"encryptionKey":"abc123"}', '{"encryptionKey":"[REDACTED]"}'),
        ('{"masterKey":"abc123"}', '{"masterKey":"[REDACTED]"}'),
        ('{"passphrase":"abc123"}', '{"passphrase":"[REDACTED]"}'),
        ('{"credential":"abc123"}', '{"credential":"[REDACTED]"}'),
        ('{"credentials":"abc123"}', '{"credentials":"[REDACTED]"}'),
        ("clientSecret=abc123", "clientSecret=[REDACTED]"),
        ("privateKey=abc123", "privateKey=[REDACTED]"),
        ("clientPrivateKey=abc123", "clientPrivateKey=[REDACTED]"),
        ("privatekey=abc123", "privatekey=[REDACTED]"),
